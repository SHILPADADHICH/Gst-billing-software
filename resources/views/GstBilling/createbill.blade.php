                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{route('add-bill')}}" method="post">
                                        ...
                                        <div class="row mt-0">
                                            <div class="col-md-3">
                                                <label>CGST (%)</label>
                                                <input type="text" class="form-control border-bottom" name="cgst_amount"
                                            ...
                                            <div class="col-md-3">
                                                <label>SGST (%)</label>
                                                <input type="text" class="form-control border-bottom" name="sgst_amount"
                                            ...
                                            <div class="col-md-3">
                                                <label>IGST (%)</label>
                                                <input type="text" class="form-control border-bottom" name="igst_amount"
