                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select  class="form-control border-bottom " name="party_type" value="{{$party->part_type}}" selected
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control border-bottom"
                                    id="validationCustom01" value="{{$party->full_name}}"name="full_name" placeholder="Enter client's full name"
                                    >
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="phone_no" value="{{$party->phone_no}}"class="form-control border-bottom "
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control border-bottom " value="{{$party->address}}"
